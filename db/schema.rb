...
ActiveRecord::Schema.define(version: 20141127142401) do
  ...
  add_index "teacher_contracts", ["school_id"], name: "index_teacher_contracts_on_school_id", using: :btree
  add_index "teacher_contracts", ["teacher_id"], name: "index_teacher_contracts_on_teacher_id", using: :btree
